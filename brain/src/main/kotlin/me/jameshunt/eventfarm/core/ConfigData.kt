...
//    """{"id":"00000000-0000-0000-0002-000000000000","className":"me.jameshunt.eventfarm.device.ezohum.AtlasScientificEzoHumController${'$'}Config","ezoHumInputId":"00000000-0000-0000-0000-000000000005"}""",
    ...
    """{"id":"00000000-0000-0000-0004-100000000000","className":"me.jameshunt.eventfarm.customcontroller.WateringController${'$'}Config","schedulableId":"00000000-0000-0000-0000-000000000102", "schedulableIndex": 1,"periodMillis":"2000000", "durationMillis": 2500}""",
)
