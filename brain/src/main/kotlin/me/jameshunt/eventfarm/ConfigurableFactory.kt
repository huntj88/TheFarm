...
val listOfJson = listOf(
    ...
    """{"id":"00000000-0000-0000-0000-000000000005","className":"me.jameshunt.eventfarm.AtlasScientificEzoHum${'$'}Config","name":"temp and humidity sensor"}""",
    """{"id":"00000000-0000-0000-0000-000000000007","className":"me.jameshunt.eventfarm.VPDFunction${'$'}Config","temperatureId":"00000000-0000-0000-0000-000000000005","humidityId":"00000000-0000-0000-0000-000000000005"}""",
...
//    """{"id":"00000000-0000-0000-0002-000000000000","className":"me.jameshunt.eventfarm.controller.ECPHExclusiveLockController${'$'}Config","ecInputId":"00000000-0000-0000-0000-000000000005","phInputId":"00000000-0000-0000-0000-000000000006"}""",
    """{"id":"00000000-0000-0000-0002-000000000000","className":"me.jameshunt.eventfarm.controller.AtlasScientificEzoHumController${'$'}Config","ezoHumInputId":"00000000-0000-0000-0000-000000000005"}""",
