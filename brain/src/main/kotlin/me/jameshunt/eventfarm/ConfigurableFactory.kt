...
val listOfJson = listOf(
    ...
    """{"id":"00000000-0000-0000-0003-000000000000","className":"me.jameshunt.eventfarm.DepthSensorInput${'$'}Config","name":"returns distance water is from the sensor, and a percent remaining based on the config depth ","depthOfTankCentimeters":"20"}""",
